...
echo "   ~/Library/Group Containers/group.TX645N2QBW.com.example.mac.PromiseKeeper/widget_debug.log"
echo ""
echo "7. You can tail the log file in Terminal:"
echo "   tail -f ~/Library/Group\\ Containers/group.TX645N2QBW.com.example.mac.PromiseKeeper/widget_debug.log"
echo ""
echo "========================================="
